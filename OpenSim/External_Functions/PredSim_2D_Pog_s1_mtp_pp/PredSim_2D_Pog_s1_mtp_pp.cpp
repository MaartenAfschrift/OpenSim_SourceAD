...
int F_generic(const T** arg, T** res) {
	...
	/// Body specifications
	pelvis = new OpenSim::Body("pelvis", 10.027, Vec3(-0.0649, 0, 0), Inertia(0.076, 0.076, 0.076, 0, 0, 0));
	femur_l = new OpenSim::Body("femur_l", 7.92, Vec3(0, -0.170467, 0), Inertia(0.1146, 0.030, 0.121, 0, 0, 0));
	femur_r = new OpenSim::Body("femur_r", 7.92, Vec3(0, -0.170467, 0), Inertia(0.1146, 0.030, 0.121, 0, 0, 0));
	tibia_l = new OpenSim::Body("tibia_l", 3.1568, Vec3(0, -0.17688, 0), Inertia(0.0385, 0.003897, 0.03905, 0, 0, 0));
	tibia_r = new OpenSim::Body("tibia_r", 3.1568, Vec3(0, -0.17688, 0), Inertia(0.0385, 0.003897, 0.03905, 0, 0, 0));
	...
	torso = new OpenSim::Body("torso", 29.1512, Vec3(-0.0301, 0.321, 0), Inertia(1.2732, 0.66252, 1.27329, 0, 0, 0));
	/// Joints
	/// Hip_l transform
	...
	hip_l = new CustomJoint("hip_l", *pelvis, Vec3(-0.0649, -0.0606, -0.0782), Vec3(0), *femur_l, Vec3(0), Vec3(0), st_hip_l);
	hip_r = new CustomJoint("hip_r", *pelvis, Vec3(-0.0649, -0.0606, 0.0782), Vec3(0), *femur_r, Vec3(0), Vec3(0), st_hip_r);
	knee_l = new CustomJoint("knee_l", *femur_l, Vec3(-0.0045, -0.3969, 0), Vec3(0), *tibia_l, Vec3(0), Vec3(0), st_knee_l);
	knee_r = new CustomJoint("knee_r", *femur_r, Vec3(-0.0045, -0.3969, 0), Vec3(0), *tibia_r, Vec3(0), Vec3(0), st_knee_r);
	ankle_l = new PinJoint("ankle_l", *tibia_l, Vec3(0, -0.407, 0), Vec3(0), *talus_l, Vec3(0), Vec3(0));
	ankle_r = new PinJoint("ankle_r", *tibia_r, Vec3(0, -0.407, 0), Vec3(0), *talus_r, Vec3(0), Vec3(0));
	...
	back = new PinJoint("back", *pelvis, Vec3(-0.09239, 0.0748, 0), Vec3(0), *torso, Vec3(0), Vec3(0));
