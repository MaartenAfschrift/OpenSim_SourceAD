...
int F_generic(const T** arg, T** res) {
	...
	OpenSim::Body* bodyInfo8;
	OpenSim::Body* bodyInfo9;
	OpenSim::Body* bodyInfo10;
    /// Joints
	...
	OpenSim::PinJoint* pendulum8;
	OpenSim::PinJoint* pendulum9;
	OpenSim::PinJoint* pendulum10;
	...
	bodyInfo2 = new OpenSim::Body("body2", 46, Vec3(0, 0.365, 0),
            Inertia(2.9));
	...
	bodyInfo8 = new OpenSim::Body("body8", 30, Vec3(0, 0.5, 0), Inertia(3.0));
	bodyInfo9 = new OpenSim::Body("body9", 30, Vec3(0, 0.5, 0), Inertia(3.0));
	bodyInfo10 = new OpenSim::Body("body10", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	...
	pendulum4 = new PinJoint("pendulum4", *bodyInfo3, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo4, Vec3(0), Vec3(0));
	pendulum5 = new PinJoint("pendulum5", *bodyInfo4, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo5, Vec3(0), Vec3(0));
	pendulum6 = new PinJoint("pendulum6", *bodyInfo5, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo6, Vec3(0), Vec3(0));
	pendulum7 = new PinJoint("pendulum7", *bodyInfo6, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo7, Vec3(0), Vec3(0));
	pendulum8 = new PinJoint("pendulum8", *bodyInfo7, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo8, Vec3(0), Vec3(0));
	pendulum9 = new PinJoint("pendulum9", *bodyInfo8, Vec3(0, 1.0, 0), Vec3(0),
            *bodyInfo9, Vec3(0), Vec3(0));
	pendulum10 = new PinJoint("pendulum10", *bodyInfo9, Vec3(0, 1.0, 0),
            Vec3(0), *bodyInfo10, Vec3(0), Vec3(0));
	...
	model->addBody(bodyInfo8);
	model->addBody(bodyInfo9);
	model->addBody(bodyInfo10);
	...
	model->addJoint(pendulum8);
	model->addJoint(pendulum9);
	model->addJoint(pendulum10);
