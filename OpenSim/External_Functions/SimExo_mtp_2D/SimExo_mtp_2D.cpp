...
int F_generic(const T** arg, T** res) {
	...
	osim_double_adouble mTibia = 3.05815503574821;
    ...
    Vec3 locsphere_front_l = Vec3(0.025, -0.0086248, -0.00885518);
    Vec3 locSphere_heel_r = Vec3(0.031307527581931796, 0.010435842527310599, 0);
    Vec3 locsphere_front_r = Vec3(0.025, -0.0086248, -0.00885518);
    ...
    HC_front_r = new HuntCrossleyForce_smooth("sphere_front_r", "toes_r", locsphere_front_r, radiussphere_front,
    ...
    HC_front_r->connectSocket_body_sphere(*toes_r);
    ...
    HC_heel_l = new HuntCrossleyForce_smooth("sphere_heel_l", "calcn_l", locSphere_heel_l, radiusSphere_heel,
        stiffness_heel, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_front_l = new HuntCrossleyForce_smooth("sphere_front_l", "toes_l", locsphere_front_l, radiussphere_front,
        stiffness_front, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    HC_front_l->connectSocket_body_sphere(*toes_l);
    ...
    /// Add contact forces to appliedBodyForces (Here not only tot the calcaneous)
    /// Right foot
    ...
    appliedBodyForces[nfoot_r] = appliedBodyForces[nfoot_r] + GRF_heel_r;
	appliedBodyForces[ntoes_r] = appliedBodyForces[ntoes_r] + GRF_front_r;
    /// Left foot
    ...
    appliedBodyForces[nfoot_l] = appliedBodyForces[nfoot_l] + GRF_heel_l;
	appliedBodyForces[ntoes_l] = appliedBodyForces[ntoes_l] + GRF_front_l;
    /// knownUdot
