...
int F_generic(const T** arg, T** res) {
	...
	Vec3 COMTibia = Vec3(0, -0.17688, 0);
	Vec3 COMTalus = Vec3(0, 0, 0);
	osim_double_adouble lTibia = 0.396;
	osim_double_adouble mTibia = 3.1568;
	osim_double_adouble mTalus = 0.082485638186061;
	Vec3 ITibia = Vec3(.0385, 0.003897, 0.03905);
