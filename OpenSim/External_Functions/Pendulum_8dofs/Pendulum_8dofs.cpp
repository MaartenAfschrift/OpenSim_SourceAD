...
int F_generic(const T** arg, T** res) {
	...
	bodyInfo2 = new OpenSim::Body("body2", 46, Vec3(0, 0.365, 0),
            Inertia(2.9));
	bodyInfo3 = new OpenSim::Body("body3", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	bodyInfo4 = new OpenSim::Body("body4", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	bodyInfo5 = new OpenSim::Body("body5", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	bodyInfo6 = new OpenSim::Body("body6", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	bodyInfo7 = new OpenSim::Body("body7", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
	bodyInfo8 = new OpenSim::Body("body8", 30, Vec3(0, 0.5, 0),
            Inertia(3.0));
