...
// */
//void ExternalLoads::transformPointsExpressedInGroundToAppliedBodies(const Storage &kinematics, osim_double_adouble startTime, osim_double_adouble endTime)
//{
//    for(int i=0; i<getSize(); i++){
...
//}
//
//ExternalForce* ExternalLoads::transformPointExpressedInGroundToAppliedBody(const ExternalForce &exForce, const Storage &kinematics, osim_double_adouble startTime, osim_double_adouble endTime)
//{
...
//            _lowpassCutoffFrequencyForLoadKinematics = kinFilterNode->getValueAs<osim_double_adouble>();
//            }
