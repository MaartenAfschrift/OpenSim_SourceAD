...
//    addCacheVariable<osim_double_adouble>("force_magnitude", 0.0, SimTK::Stage::Velocity);
//}
//
////=============================================================================
//// Computing
...
//
//// Compute the force
//osim_double_adouble ExpressionBasedCoordinateForce::calcExpressionForce(const SimTK::State& s ) const
//{
//    using namespace SimTK;
//    osim_double_adouble q = _coord->getValue(s);
//    osim_double_adouble qdot = _coord->getSpeedValue(s);
//    std::map<std::string, osim_double_adouble> forceVars;
//    forceVars["q"] = q;
//    forceVars["qdot"] = qdot;
//    osim_double_adouble forceMag = _forceProg.evaluate(forceVars);
//    setCacheVariableValue<osim_double_adouble>(s, "force_magnitude", forceMag);
//    return forceMag;
//}
//
//// get the force magnitude that has already been computed
//const osim_double_adouble& ExpressionBasedCoordinateForce::
//    getForceMagnitude(const SimTK::State& s)
//{
//    return getCacheVariableValue<osim_double_adouble>(s, "force_magnitude");
//}
//
//
////=============================================================================
...
//Array<osim_double_adouble> ExpressionBasedCoordinateForce::getRecordValues(const SimTK::State& state) const {
//    OpenSim::Array<osim_double_adouble> values(0.0, 0, 1);
