...
void Model::assemble(SimTK::State& s, const Coordinate *coord, osim_double_adouble weight)
{
...
void Model::createMultibodySystem()
{
    ...
    osim_double_adouble magnitude = get_gravity().norm();
 ...
 */
bool Model::scale(SimTK::State& s, const ScaleSet& aScaleSet, osim_double_adouble aFinalMass, bool aPreserveMassDist)
{
    int i;
                             ...
                             bool warnUnspecifiedStates) const
{
    ...
    osim_double_adouble assignedValue = SimTK::NaN;
...
void Model::formQStorage(const Storage& originalStorage, Storage& qStorage) {
    ...
    for (int row =0; row< originalStorage.getSize(); row++){
        ...
        for(int column=0; column< nq; column++){
            osim_double_adouble valueInOriginalStorage=0.0;
            if (mapColumns[column]!=-1)
 ...
 */
osim_double_adouble Model::getTotalMass(const SimTK::State &s) const
{
