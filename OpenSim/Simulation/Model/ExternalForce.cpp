...
//    Array<osim_double_adouble> time;
//    Array<Array<osim_double_adouble> > force;
//    Array<Array<osim_double_adouble> > point;
//    Array<Array<osim_double_adouble> > torque;
//
//    // Get data
...
//{
//    osim_double_adouble time = state.getTime();
//
...
// */
//Vec3 ExternalForce::getForceAtTime(osim_double_adouble aTime) const  
//{
...
//}
//
//Vec3 ExternalForce::getPointAtTime(osim_double_adouble aTime) const
//{
//    SimTK::Vector timeAsVector(1, aTime);
...
//}
//
//Vec3 ExternalForce::getTorqueAtTime(osim_double_adouble aTime) const
//{
//    SimTK::Vector timeAsVector(1, aTime);
...
// */
//OpenSim::Array<osim_double_adouble> ExternalForce::getRecordValues(const SimTK::State& state) const
//{
//    OpenSim::Array<osim_double_adouble>  values(SimTK::NaN);
//    osim_double_adouble time = state.getTime();
//
//    if (_appliesForce) {
//        Vec3 force = getForceAtTime(time);
