...
//        return;
//
//    osim_double_adouble xangle = getCoordinate(BallJoint::Coord::Rotation1X).getDefaultValue();
//    osim_double_adouble yangle = getCoordinate(BallJoint::Coord::Rotation2Y).getDefaultValue();
//    osim_double_adouble zangle = getCoordinate(BallJoint::Coord::Rotation3Z).getDefaultValue();
