...
//        osim_double_adouble xangle = getCoordinate(EllipsoidJoint::Coord::Rotation1X).getDefaultValue();
//        osim_double_adouble yangle = getCoordinate(EllipsoidJoint::Coord::Rotation2Y).getDefaultValue();
//        osim_double_adouble zangle = getCoordinate(EllipsoidJoint::Coord::Rotation3Z).getDefaultValue();
