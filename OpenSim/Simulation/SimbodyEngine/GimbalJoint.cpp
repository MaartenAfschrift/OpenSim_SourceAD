...
//        return;
//
//    osim_double_adouble xangle = getCoordinate(GimbalJoint::Coord::Rotation1X).getDefaultValue();
//    osim_double_adouble yangle = getCoordinate(GimbalJoint::Coord::Rotation2Y).getDefaultValue();
//    osim_double_adouble zangle = getCoordinate(GimbalJoint::Coord::Rotation3Z).getDefaultValue();
