...
//    const osim_double_adouble scale;
//
//public:
//    
//    CompoundFunction(const SimTK::Function *cf, osim_double_adouble scale) : f1(cf), scale(scale) {
//    }
//
...
//        osim_double_adouble scaleFactor = 1.0;
