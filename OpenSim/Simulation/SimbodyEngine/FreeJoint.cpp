...
//        osim_double_adouble xangle = getCoordinate(FreeJoint::Coord::Rotation1X).getDefaultValue();
//        osim_double_adouble yangle = getCoordinate(FreeJoint::Coord::Rotation2Y).getDefaultValue();
//        osim_double_adouble zangle = getCoordinate(FreeJoint::Coord::Rotation3Z).getDefaultValue();
