...
//    osim_double_adouble constraintWeight) : Solver(model),
...
//}
//
//void AssemblySolver::setAccuracy(osim_double_adouble accuracy)
//{
//    _accuracy = accuracy;
...
//    _assembler->setAccuracy(_accuracy.value());
//
...
//    be updated directly */
//void AssemblySolver::updateCoordinateReference(const std::string &coordName, osim_double_adouble value, osim_double_adouble weight)
//{
//    SimTK::Array_<CoordinateReference>::iterator p;
//
//    // Cycle through coordinate references
