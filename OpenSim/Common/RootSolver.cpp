...
// * 
// */
//Array<osim_double_adouble> RootSolver::
//solve(const SimTK::State& s, const Array<osim_double_adouble> &ax,const Array<osim_double_adouble> &bx,
//        const Array<osim_double_adouble> &tol)
//{
//    int i;
//    int N = _function->getNX();
//
//    Array<osim_double_adouble> a(0.0,N),b(0.0,N),c(0.0,N);
//    Array<osim_double_adouble> fa(0.0,N),fb(0.0,N),fc(0.0,N);
//    Array<osim_double_adouble> prev_step(0.0,N);
//    Array<osim_double_adouble> tol_act(0.0,N);
//    Array<osim_double_adouble> p(0.0,N);
//    Array<osim_double_adouble> q(0.0,N);
//    Array<osim_double_adouble> new_step(0.0,N);
//
//    bool finished = false;
...
//            if(fabs(new_step[i])<=tol_act[i] || fb[i]==(osim_double_adouble)0.0 ) {
//                converged[i] = iter;
//                continue;
//            }
//
...
//                if( p[i]>(osim_double_adouble)0.0 ) {
//                    q[i] = -q[i];
//                } else {
//                    p[i] = -p[i];
//                }
...
//                if( new_step[i] > (osim_double_adouble)0.0 ) {
