...
///**
// */
//PiecewiseConstantFunction::PiecewiseConstantFunction(int aN,const osim_double_adouble *aX,const osim_double_adouble *aY,
//       const string &aName) :
//       _x(_propX.getValueDblArray()),
//       _y(_propY.getValueDblArray())
//{
...
//				 osim_double_adouble x[2] = {0.0, 1.0}, y[2];
...
// * @see getN();
// */
//const Array<osim_double_adouble>& PiecewiseConstantFunction::getX() const
//{
//       return(_x);
//}
////_____________________________________________________________________________
...
// * @see getCoefficients();
// */
//const Array<osim_double_adouble>& PiecewiseConstantFunction::getY() const
//{
//       return(_y);
//}
////_____________________________________________________________________________
...
// * @see getN();
// */
//const osim_double_adouble* PiecewiseConstantFunction::getXValues() const
//{
//       return(&_x[0]);
//}
////_____________________________________________________________________________
...
// */
//const osim_double_adouble* PiecewiseConstantFunction::getYValues() const
//{
//       return(&_y[0]);
//}
//
...
// */
//osim_double_adouble PiecewiseConstantFunction::
//evaluateTotalFirstDerivative(osim_double_adouble aX, osim_double_adouble aDxdt) const
//{
//       return 0.0;
//}
//
...
// */
//osim_double_adouble PiecewiseConstantFunction::
//evaluateTotalSecondDerivative(osim_double_adouble aX, osim_double_adouble aDxdt, osim_double_adouble aD2xdt2) const
//{
//       return 0.0;
//}
//
//osim_double_adouble PiecewiseConstantFunction::getX(int aIndex) const
//{
...
//}
//
//osim_double_adouble PiecewiseConstantFunction::getY(int aIndex) const
//{
...
//}
//
//void PiecewiseConstantFunction::setX(int aIndex, osim_double_adouble aValue)
//{
//       if (aIndex >= 0 && aIndex < _x.getSize()) {
//             _x[aIndex] = aValue;
//       } else {
...
//}
//
//void PiecewiseConstantFunction::setY(int aIndex, osim_double_adouble aValue)
//{
//       if (aIndex >= 0 && aIndex < _y.getSize()) {
//             _y[aIndex] = aValue;
//       } else {
...
//}
//
//int PiecewiseConstantFunction::addPoint(osim_double_adouble aX, osim_double_adouble aY)
//{
//       int i=0;
...
//}
//
//osim_double_adouble PiecewiseConstantFunction::calcValue(const Vector& x) const
//{
//    int n = _x.getSize();
//	osim_double_adouble aX = x[0].value();
//
...
//}
//
//osim_double_adouble PiecewiseConstantFunction::calcDerivative(const std::vector<int>& derivComponents, const Vector& x) const
//{
//    return 0.0;
//}
//
