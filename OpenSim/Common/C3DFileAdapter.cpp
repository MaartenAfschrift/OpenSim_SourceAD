...
//SimTK::Matrix_<osim_double_adouble>
//convertToSimtkMatrix(const Eigen::Matrix<_Scalar, _Rows, _Cols>&
//                     eigenMat) {
//    SimTK::Matrix_<osim_double_adouble> simtkMat{static_cast<int>(eigenMat.rows()),
...
//
//        std::vector<osim_double_adouble> marker_times(marker_nrow);
...
//        }
//
//        osim_double_adouble time_step{1.0 / acquisition->GetPointFrequency()};
...
//
//    std::vector<SimTK::Matrix_<osim_double_adouble>> fpCalMatrices{};
//    std::vector<SimTK::Matrix_<osim_double_adouble>> fpCorners{};
//    std::vector<SimTK::Matrix_<osim_double_adouble>> fpOrigins{};
...
//        
//        std::vector<osim_double_adouble> force_times(nf);
//        SimTK::Matrix_<SimTK::Vec3> force_matrix(nf, labels.size());
//
//        osim_double_adouble time_step{1.0 / acquisition->GetAnalogFrequency()};
//
//        for(int f = 0; f < nf;  ++f) {
