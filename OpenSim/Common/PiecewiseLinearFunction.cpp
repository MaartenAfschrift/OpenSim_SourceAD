...
///**
// */
//PiecewiseLinearFunction::PiecewiseLinearFunction(int aN,const osim_double_adouble *aX,const osim_double_adouble *aY,
//    const string &aName) :
//    _x(_propX.getValueDblArray()),
//    _y(_propY.getValueDblArray()),
//   _b(0.0)
...
// * @see getN();
// */
//const Array<osim_double_adouble>& PiecewiseLinearFunction::getX() const
//{
//    return(_x);
//}
////_____________________________________________________________________________
...
// * @see getCoefficients();
// */
//const Array<osim_double_adouble>& PiecewiseLinearFunction::getY() const
//{
//    return(_y);
//}
////_____________________________________________________________________________
...
// * @see getN();
// */
//const osim_double_adouble* PiecewiseLinearFunction::getXValues() const
//{
//    return(&_x[0]);
//}
////_____________________________________________________________________________
...
// */
//const osim_double_adouble* PiecewiseLinearFunction::getYValues() const
//{
//    return(&_y[0]);
//}
//
...
//}   
//
//osim_double_adouble PiecewiseLinearFunction::getX(int aIndex) const
//{
...
//}
//
//osim_double_adouble PiecewiseLinearFunction::getY(int aIndex) const
//{
...
//}
//
//void PiecewiseLinearFunction::setX(int aIndex, osim_double_adouble aValue)
//{
//    if (aIndex >= 0 && aIndex < _x.getSize()) {
//        _x[aIndex] = aValue;
//        calcCoefficients();
...
//}
//
//void PiecewiseLinearFunction::setY(int aIndex, osim_double_adouble aValue)
//{
//    if (aIndex >= 0 && aIndex < _y.getSize()) {
//        _y[aIndex] = aValue;
//        calcCoefficients();
...
//}
//
//int PiecewiseLinearFunction::addPoint(osim_double_adouble aX, osim_double_adouble aY)
//{
//    int i=0;
...
//
//    for (int i=0; i<n-1; i++) {
//		osim_double_adouble range = MAX(TINY_NUMBER, _x[i+1] - _x[i]);
//        _b[i] = (_y[i+1] - _y[i]) / range;
//    }
//    _b[n-1] = _b[n-2];
//}
//
//osim_double_adouble PiecewiseLinearFunction::calcValue(const Vector& x) const
//{
//    int n = _x.getSize();
...
//}
//
//osim_double_adouble PiecewiseLinearFunction::calcDerivative(const std::vector<int>& derivComponents, const Vector& x) const
//{
