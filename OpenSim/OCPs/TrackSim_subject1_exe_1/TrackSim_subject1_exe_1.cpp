...
constexpr int NR = 42;    // residual torques + GRFs + Origins calcaneus.
...
int F_generic(const T** arg, T** res) {
    ...
    // Calcn: positions and velocities
    ...
    if (res[0]) {
        ...
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_heel_l[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front1_l[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front2_l[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front3_l[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_heel_r[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front1_r[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front2_r[i]);
        }
        for (int i = 0; i < nc; ++i) {
            res[0][i+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc+nc] = value<T>(pos_InGround_HC_front3_r[i]);
        }
    }
    return 0;
}
