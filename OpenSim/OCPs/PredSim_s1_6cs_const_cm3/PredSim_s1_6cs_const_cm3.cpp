...
constexpr int NR = ndof+6+4*4;  // residual torques + GRFs + Origins joint.
...
int F_generic(const T** arg, T** res) {
    ...
    Vec3 locSphere_1_r(0.0022377, -0.021859, 0.012182);
    Vec3 locSphere_2_r(0.14281, -0.021859, -0.010698);
    Vec3 locSphere_3_r(0.11112, -0.021859, 0.027108);
    Vec3 locSphere_4_r(0.046817, -0.021448, -0.009267);
    Vec3 locSphere_5_r(0.041235, -0.021859, 0.001381);
    Vec3 locSphere_6_r(0.025329, -0.021448, 0.036857);
    ...
    Vec3 locSphere_1_l(0.0022377, -0.021859, -0.012182);
    Vec3 locSphere_2_l(0.14281, -0.021859, 0.010698);
    Vec3 locSphere_3_l(0.11112, -0.021859, -0.027108);
    Vec3 locSphere_4_l(0.046817, -0.021448, 0.009267);
    Vec3 locSphere_5_l(0.041235, -0.021859, -0.001381);
    Vec3 locSphere_6_l(0.025329, -0.021448, -0.036857);
    ...
    /// Contact elements
    osim_double_adouble radius_s1 = 0.048;
    osim_double_adouble radius_s2 = 0.016014;
    osim_double_adouble radius_s3 = 0.016206;
    osim_double_adouble radius_s4 = 0.035938;
    osim_double_adouble radius_s5 = 0.048;
    osim_double_adouble radius_s6 = 0.033198;
    ...
    /// Left - Definition
    HC_1_l = new HuntCrossleyForce_smooth("sphere_1_l", "calcn_l", locSphere_1_l, radius_s1,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_2_l = new HuntCrossleyForce_smooth("sphere_2_l", "calcn_l", locSphere_2_l, radius_s2,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_3_l = new HuntCrossleyForce_smooth("sphere_3_l", "calcn_l", locSphere_3_l, radius_s3,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_4_l = new HuntCrossleyForce_smooth("sphere_4_l", "toes_l", locSphere_4_l, radius_s4,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_l = new HuntCrossleyForce_smooth("sphere_5_l", "calcn_l", locSphere_5_l, radius_s5,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_6_l = new HuntCrossleyForce_smooth("sphere_6_l", "toes_l", locSphere_6_l, radius_s6,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    /// Right - Definition
    HC_1_r = new HuntCrossleyForce_smooth("sphere_1_r", "calcn_r", locSphere_1_r, radius_s1,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_2_r = new HuntCrossleyForce_smooth("sphere_2_r", "calcn_r", locSphere_2_r, radius_s2,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_3_r = new HuntCrossleyForce_smooth("sphere_3_r", "calcn_r", locSphere_3_r, radius_s3,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_4_r = new HuntCrossleyForce_smooth("sphere_4_r", "toes_r", locSphere_4_r, radius_s4,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_r = new HuntCrossleyForce_smooth("sphere_5_r", "calcn_r", locSphere_5_r, radius_s5,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_6_r = new HuntCrossleyForce_smooth("sphere_6_r", "toes_r", locSphere_6_r, radius_s6,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    if (res[0]) {
        ...
        res[0][ndof + nc + nc]     = value<T>(calcn_or_r[0]);   // calcn_or_r_x
        res[0][ndof + nc + nc + 1] = value<T>(calcn_or_r[2]);   // calcn_or_r_z
        res[0][ndof + nc + nc + 2] = value<T>(calcn_or_l[0]);   // calcn_or_l_x
        res[0][ndof + nc + nc + 3] = value<T>(calcn_or_l[2]);   // calcn_or_l_x
        res[0][ndof + nc + nc + 4] = value<T>(femur_or_r[0]);   // femur_or_r_x
        res[0][ndof + nc + nc + 5] = value<T>(femur_or_r[2]);   // femur_or_r_z
        res[0][ndof + nc + nc + 6] = value<T>(femur_or_l[0]);   // femur_or_l_x
        res[0][ndof + nc + nc + 7] = value<T>(femur_or_l[2]);   // femur_or_l_z
        res[0][ndof + nc + nc + 8] = value<T>(hand_or_r[0]);    // hand_or_r_x
        res[0][ndof + nc + nc + 9] = value<T>(hand_or_r[2]);    // hand_or_r_z
        res[0][ndof + nc + nc + 10] = value<T>(hand_or_l[0]);   // hand_or_l_x
        res[0][ndof + nc + nc + 11] = value<T>(hand_or_l[2]);   // hand_or_l_z
        res[0][ndof + nc + nc + 12] = value<T>(tibia_or_r[0]);  // tibia_or_r_x
        res[0][ndof + nc + nc + 13] = value<T>(tibia_or_r[2]);  // tibia_or_r_z
        res[0][ndof + nc + nc + 14] = value<T>(tibia_or_l[0]);  // tibia_or_l_x
        res[0][ndof + nc + nc + 15] = value<T>(tibia_or_l[2]);  // tibia_or_l_z
    }
    return 0;
}
