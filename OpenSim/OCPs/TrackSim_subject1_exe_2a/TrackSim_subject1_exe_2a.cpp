...
constexpr int NP = 32;          // parameters contact model
...
int F_generic(const T** arg, T** res) {
    ...
    Vec3 AppliedPointForce_heel_l, AppliedPointForce_front1_l;
    Vec3 AppliedPointForce_front2_l, AppliedPointForce_front3_l;
    Vec3 AppliedPointForce_heel_r, AppliedPointForce_front1_r;
    Vec3 AppliedPointForce_front2_r, AppliedPointForce_front3_r;
    Vec3 locSphere_heel_r;
    Vec3 locSphere_front1_r;
    Vec3 locSphere_front2_r;
    Vec3 locSphere_front3_r;
    int nc = 3; // # components in Vec3
    for (int i = 0; i < nc; ++i) {
        AppliedPointForce_heel_l[i]     = up[i];
        AppliedPointForce_front1_l[i]   = up[i + nc];
        AppliedPointForce_front2_l[i]   = up[i + nc + nc];
        AppliedPointForce_front3_l[i]   = up[i + nc + nc + nc];
        AppliedPointForce_heel_r[i]     = up[i + nc + nc + nc + nc];
        AppliedPointForce_front1_r[i]   = up[i + nc + nc + nc + nc + nc];
        AppliedPointForce_front2_r[i]   = up[i + nc + nc + nc + nc + nc + nc];
        AppliedPointForce_front3_r[i]   = up[i + nc + nc + nc + nc + nc + nc + nc];
    }
    // Vertical positions are fixed
    locSphere_heel_r[1] = 0.010435842527310599;
    locSphere_front1_r[1] = -0.015653763790965898;
    locSphere_front2_r[1] = -0.015653763790965898;
    locSphere_front3_r[1] = -0.01461017953823484;
    int count = 0;
    for (int i = 0; i < nc; i+=2) {
        locSphere_heel_r[i]     = up[count + nc + nc + nc + nc + nc + nc + nc + nc];
        locSphere_front1_r[i]   = up[count + nc + nc + nc + nc + nc + nc + nc + nc + nc-1];
        locSphere_front2_r[i]   = up[count + nc + nc + nc + nc + nc + nc + nc + nc + nc-1 + nc-1];
        locSphere_front3_r[i]   = up[count + nc + nc + nc + nc + nc + nc + nc + nc + nc-1 + nc-1 + nc-1];
        ++count;
    }

    Vec3 locSphere_heel_l(locSphere_heel_r[0],locSphere_heel_r[1],-locSphere_heel_r[2]);
    Vec3 locSphere_front1_l(locSphere_front1_r[0],locSphere_front1_r[1],-locSphere_front1_r[2]);
    Vec3 locSphere_front2_l(locSphere_front2_r[0],locSphere_front2_r[1],-locSphere_front2_r[2]);
    Vec3 locSphere_front3_l(locSphere_front3_r[0],locSphere_front3_r[1],-locSphere_front3_r[2]);
    ...
    Vec3 contactPointPos_InGround_HC_heel_l_adj = contactPointPos_InGround_HC_heel_l - 0.5*contactPointPos_InGround_HC_heel_l[1]*normal;
    Vec3 contactPointPos_InBody_HC_heel_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_heel_l_adj, *calcn_l);
    // Front1 l
    ...
    Vec3 contactPointPos_InGround_HC_front1_l_adj = contactPointPos_InGround_HC_front1_l - 0.5*contactPointPos_InGround_HC_front1_l[1]*normal;
    Vec3 contactPointPos_InBody_HC_front1_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front1_l_adj, *calcn_l);
    // Front2 l
    ...
    Vec3 contactPointPos_InGround_HC_front2_l_adj = contactPointPos_InGround_HC_front2_l - 0.5*contactPointPos_InGround_HC_front2_l[1]*normal;
    Vec3 contactPointPos_InBody_HC_front2_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front2_l_adj, *calcn_l);
    // Front3 l
    ...
    Vec3 contactPointPos_InGround_HC_front3_l_adj = contactPointPos_InGround_HC_front3_l - 0.5*contactPointPos_InGround_HC_front3_l[1]*normal;
    Vec3 contactPointPos_InBody_HC_front3_l = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front3_l_adj, *calcn_l);
    // Heel r
    ...
    Vec3 contactPointPos_InGround_HC_heel_r_adj = contactPointPos_InGround_HC_heel_r - 0.5*contactPointPos_InGround_HC_heel_r[1]*normal;
    Vec3 contactPointPos_InBody_HC_heel_r = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_heel_r_adj, *calcn_r);
    // Front1 r
    ...
    Vec3 contactPointPos_InGround_HC_front1_r_adj = contactPointPos_InGround_HC_front1_r - 0.5*contactPointPos_InGround_HC_front1_r[1]*normal;
    Vec3 contactPointPos_InBody_HC_front1_r = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front1_r_adj, *calcn_r);
    // Front2 r
    ...
    Vec3 contactPointPos_InGround_HC_front2_r_adj = contactPointPos_InGround_HC_front2_r - 0.5*contactPointPos_InGround_HC_front2_r[1]*normal;
    Vec3 contactPointPos_InBody_HC_front2_r = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front2_r_adj, *calcn_r);
    // Front3 r
    ...
    Vec3 contactPointPos_InGround_HC_front3_r_adj = contactPointPos_InGround_HC_front3_r - 0.5*contactPointPos_InGround_HC_front3_r[1]*normal;
    Vec3 contactPointPos_InBody_HC_front3_r = model->getGround().findStationLocationInAnotherFrame(*state, contactPointPos_InGround_HC_front3_r_adj, *calcn_r);
    // Ground reaction forces
    Vec3 GRF_r = AppliedPointForce_heel_r + AppliedPointForce_front1_r + AppliedPointForce_front2_r + AppliedPointForce_front3_r;
    Vec3 GRF_l = AppliedPointForce_heel_l + AppliedPointForce_front1_l + AppliedPointForce_front2_l + AppliedPointForce_front3_l;
    // Apply contact forces to model
    model->getMatterSubsystem().addInStationForce(*state, calcn_l->getMobilizedBodyIndex(), contactPointPos_InBody_HC_heel_l, AppliedPointForce_heel_l, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_l->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front1_l, AppliedPointForce_front1_l, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_l->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front2_l, AppliedPointForce_front2_l, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_l->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front3_l, AppliedPointForce_front3_l, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_r->getMobilizedBodyIndex(), contactPointPos_InBody_HC_heel_r, AppliedPointForce_heel_r, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_r->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front1_r, AppliedPointForce_front1_r, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_r->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front2_r, AppliedPointForce_front2_r, appliedBodyForces);
    model->getMatterSubsystem().addInStationForce(*state, calcn_r->getMobilizedBodyIndex(), contactPointPos_InBody_HC_front3_r, AppliedPointForce_front3_r, appliedBodyForces);
    /// knownUdot
