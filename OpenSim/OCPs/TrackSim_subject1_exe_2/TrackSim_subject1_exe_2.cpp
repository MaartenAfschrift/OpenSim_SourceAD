...
constexpr int NP = 28;          // parameters contact model
...
int F_generic(const T** arg, T** res) {
    ...
    /// contact elements
    const Vec3 locSphere_heel_r =
        Vec3(0.031307527581931796, 0.010435842527310599, 0);
    const Vec3 locSphere_front1_r =
        Vec3(0.18262724422793547, -0.015653763790965898, -0.0260896063182765);
    const Vec3 locSphere_front2_r =
        Vec3(0.1774093229642802, -0.015653763790965898, 0.005217921263655299);
    const Vec3 locSphere_front3_r =
        Vec3(0.1617555591733143, -0.01461017953823484, 0.041743370109242395);
    const Vec3 locSphere_heel_l =
        Vec3(0.031307527581931796, 0.010435842527310599, 0);
    const Vec3 locSphere_front1_l =
        Vec3(0.18262724422793547, -0.015653763790965898, 0.0260896063182765);
    const Vec3 locSphere_front2_l =
        Vec3(0.1774093229642802, -0.015653763790965898, -0.005217921263655299);
    const Vec3 locSphere_front3_l =
        Vec3(0.1617555591733143, -0.01461017953823484, -0.041743370109242395);
    /// Model
    ...
    osim_double_adouble radiusSphere_heel   = up[nc + nc + nc + nc + nc + nc + nc + nc];
    osim_double_adouble radiusSphere_front1 = up[nc + nc + nc + nc + nc + nc + nc + nc + 1];
    osim_double_adouble radiusSphere_front2 = up[nc + nc + nc + nc + nc + nc + nc + nc + 2];
    osim_double_adouble radiusSphere_front3 = up[nc + nc + nc + nc + nc + nc + nc + nc + 3];
