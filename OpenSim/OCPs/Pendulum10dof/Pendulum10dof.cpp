...
constexpr int NX = 20; // states
constexpr int NU = 10; // controls
constexpr int NP = 1; // perturbation
constexpr int NR = 10; // residual forces
...
int F_generic(const T** arg, T** res) {
	...
	bodyInfo10 = new OpenSim::Body("body10", 30, Vec3(0, 0.5, 0), Inertia(3.0));
	...
	pendulum8 = new PinJoint("pendulum8",
		*bodyInfo7, Vec3(0, 1.0, 0), Vec3(0), *bodyInfo8, Vec3(0), Vec3(0));
	pendulum9 = new PinJoint("pendulum9",
		*bodyInfo8, Vec3(0, 1.0, 0), Vec3(0), *bodyInfo9, Vec3(0), Vec3(0));
	pendulum10 = new PinJoint("pendulum10",
		*bodyInfo9, Vec3(0, 1.0, 0), Vec3(0), *bodyInfo10, Vec3(0), Vec3(0));
