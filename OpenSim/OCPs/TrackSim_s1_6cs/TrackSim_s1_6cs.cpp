...
int F_generic(const T** arg, T** res) {
    ...
    Vec3 locSphere_s1_r(0.00190115788407966, -0.021859, -0.00382630379623308);
    Vec3 locSphere_s2_r(0.148386399942063, -0.021859, -0.028713422052654);
    Vec3 locSphere_s3_r(0.133001170607051, -0.021859, 0.0516362473449566);
    Vec3 locSphere_s4_r(0.06, -0.0214476, -0.0187603084619177);
    Vec3 locSphere_s5_r(0.0662346661991635, -0.021859, 0.0263641606741698);
    Vec3 locSphere_s6_r(0.045, -0.0214476, 0.0618569567549652);
    Vec3 locSphere_s1_l(0.00190115788407966, -0.021859, 0.00382630379623308);
    Vec3 locSphere_s2_l(0.148386399942063, -0.021859, 0.028713422052654);
    Vec3 locSphere_s3_l(0.133001170607051, -0.021859, -0.0516362473449566);
    Vec3 locSphere_s4_l(0.06, -0.0214476, 0.0187603084619177);
    Vec3 locSphere_s5_l(0.0662346661991635, -0.021859, -0.0263641606741698);
    Vec3 locSphere_s6_l(0.045, -0.0214476, -0.0618569567549652);
    /// Left - Definition
    ...
    HC_3_l = new HuntCrossleyForce_smooth("sphere_3_l", "calcn_l", locSphere_s3_l, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_4_l = new HuntCrossleyForce_smooth("sphere_4_l", "toes_l", locSphere_s4_l, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_l = new HuntCrossleyForce_smooth("sphere_5_l", "calcn_l", locSphere_s5_l, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_6_l = new HuntCrossleyForce_smooth("sphere_6_l", "toes_l", locSphere_s6_l, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    HC_3_r = new HuntCrossleyForce_smooth("sphere_3_r", "calcn_r", locSphere_s3_r, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_4_r = new HuntCrossleyForce_smooth("sphere_4_r", "toes_r", locSphere_s4_r, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_5_r = new HuntCrossleyForce_smooth("sphere_5_r", "calcn_r", locSphere_s5_r, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    HC_6_r = new HuntCrossleyForce_smooth("sphere_6_r", "toes_r", locSphere_s6_r, radiusSphere,
        stiffness, dissipation, staticFriction, dynamicFriction, viscousFriction, transitionVelocity, normal, offset);
    ...
    // Step1: Calculate contact point positions in body frames
    // s1 l
    ...
    Vec3 contactPointpos_InGround_HC_s5_l = pos_InGround_HC_s5_l - radiusSphere*normal;
    ...
    Vec3 contactPointpos_InGround_HC_s6_l = pos_InGround_HC_s6_l - radiusSphere*normal;
    ...
    Vec3 contactPointpos_InGround_HC_s5_r = pos_InGround_HC_s5_r - radiusSphere*normal;
    ...
    Vec3 contactPointpos_InGround_HC_s6_r = pos_InGround_HC_s6_r - radiusSphere*normal;
    ...
    // Step3: Calculate torques
    Vec3 AppliedPointTorque_s1_l = (TR_GB_calcn_l*contactPointPos_InBody_HC_s1_l) % GRF_1_l[1];
    Vec3 AppliedPointTorque_s2_l = (TR_GB_calcn_l*contactPointPos_InBody_HC_s2_l) % GRF_2_l[1];
    Vec3 AppliedPointTorque_s3_l = (TR_GB_calcn_l*contactPointPos_InBody_HC_s3_l) % GRF_3_l[1];
    Vec3 AppliedPointTorque_s4_l = (TR_GB_toes_l*contactPointPos_InBody_HC_s4_l) % GRF_4_l[1];
    Vec3 AppliedPointTorque_s5_l = (TR_GB_calcn_l*contactPointPos_InBody_HC_s5_l) % GRF_5_l[1];
    Vec3 AppliedPointTorque_s6_l = (TR_GB_toes_l*contactPointPos_InBody_HC_s6_l) % GRF_6_l[1];
    Vec3 AppliedPointTorque_s1_r = (TR_GB_calcn_r*contactPointPos_InBody_HC_s1_r) % GRF_1_r[1];
    Vec3 AppliedPointTorque_s2_r = (TR_GB_calcn_r*contactPointPos_InBody_HC_s2_r) % GRF_2_r[1];
    Vec3 AppliedPointTorque_s3_r = (TR_GB_calcn_r*contactPointPos_InBody_HC_s3_r) % GRF_3_r[1];
    Vec3 AppliedPointTorque_s4_r = (TR_GB_toes_r*contactPointPos_InBody_HC_s4_r) % GRF_4_r[1];
    Vec3 AppliedPointTorque_s5_r = (TR_GB_calcn_r*contactPointPos_InBody_HC_s5_r) % GRF_5_r[1];
    Vec3 AppliedPointTorque_s6_r = (TR_GB_toes_r*contactPointPos_InBody_HC_s6_r) % GRF_6_r[1];
    // Step4: combine torques
    Vec3 MOM_l = AppliedPointTorque_s1_l + AppliedPointTorque_s2_l + AppliedPointTorque_s3_l + AppliedPointTorque_s4_l + AppliedPointTorque_s5_l + AppliedPointTorque_s6_l;
    Vec3 MOM_r = AppliedPointTorque_s1_r + AppliedPointTorque_s2_r + AppliedPointTorque_s3_r + AppliedPointTorque_s4_r + AppliedPointTorque_s5_r + AppliedPointTorque_s6_r;
