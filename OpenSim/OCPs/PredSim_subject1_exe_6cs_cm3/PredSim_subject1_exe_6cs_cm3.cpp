...
int F_generic(const T** arg, T** res) {
    ...
    const Vec3 locSphere_1_r =
        Vec3(0.0022377, -0.021859, 0.012182);
    const Vec3 locSphere_2_r =
        Vec3(0.14281, -0.021859, -0.010698);
    const Vec3 locSphere_3_r =
        Vec3(0.11112, -0.021859, 0.027108);
    const Vec3 locSphere_4_r =
        Vec3(0.046817, -0.021448, -0.009267);
    const Vec3 locSphere_5_r =
        Vec3(0.041235, -0.021859, 0.001381);
    const Vec3 locSphere_6_r =
        Vec3(0.025329, -0.021448, 0.036857);
